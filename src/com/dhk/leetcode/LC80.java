...
// INSIGHTS: similar to LC26.
// However, we can check for duplicate values relative to the update index for a cleaner implementation.
public class LC80 {
    ...
    private static int removeDuplicates(int[] nums) {
        ...
        short updateIndex = 2;
        for (short i = updateIndex; i < nums.length; i++) {
            if (nums[i] != nums[updateIndex - 2]) {
